...
<p>
Lorsque vous prévisualisez une répartition, vous pouvez cliquer sur le bloc associé à un étudiant, voir ses informations et réponses dans une info-bulle.<br>
...
Nombre de groupes :<input id="nbteam" min="1" style="width:40px;height:21px;margin-top:5px;margin-right:5px;" value="31" type="number" disabled="">31 / 123(4)</span>&nbsp;<button type="button" id="buildteams" class=""><strong>Prévisualisation</strong></button>&nbsp;<button type="button" id="resetteams" class="">Réinitialiser</button>&nbsp;<button type="button" id="prettify" style="">Optimiser</button>&nbsp;<button type="button" id="equalize" style="">Egaliser</button>
<ul>
...
$string['wrongcharquest']              = 'Il y a des caractères invalides dans la question';
$string['wrongcharansw']               = 'Il y a des caractères invalides dans une réponse';
